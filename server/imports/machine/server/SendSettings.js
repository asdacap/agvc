...
Meteor.methods({
  sendMachineSetting(machineId){
    ...
    Machines.sendCommand(machineId, "motorPIDMultiplierRatio:"+machine.motorPIDMultiplierRatio);
    Machines.sendCommand(machineId, "motorVoltageCompensation:"+machine.motorVoltageCompensation);
